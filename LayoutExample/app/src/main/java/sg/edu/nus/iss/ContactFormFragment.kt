...
class ContactFormFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.buttonPreview).setOnClickListener { showPreview() }
        view.findViewById<Button>(R.id.buttonSave).setOnClickListener { saveContact() }
    }
    ...
    private fun saveContact() {
        ...
        Toast.makeText(requireContext(), "Contact details have been saved.", Toast.LENGTH_SHORT).show()
        clearForm()
    }
